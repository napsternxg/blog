...
* [Name-Based Gender Classification (36 distinct sources—spanning over 150 countries and more than a century)](https://osf.io/tz38q/) - [Github](https://github.com/ianvanbuskirk/nbgc) - [Software](https://github.com/ianvanbuskirk/nomquamgender)
...
* [TASTESet recipe NER model and dataset](https://github.com/taisti/TASTEset/) - [TasteSet 2.0 - 1K annotated](https://github.com/taisti/TASTEset-2.0/) - [Entities Linked to https://foodon.org/](https://github.com/taisti/entity_linker/) - [Spacy NER Training](https://colab.research.google.com/drive/16QLMiyQpFxDc8qw64zYupsypy8BkywjB?usp=sharing)
...
* [Kaggle Whats Cooking](https://www.kaggle.com/competitions/whats-cooking/overview) - [recipe-ingredients-dataset dataset](https://www.kaggle.com/datasets/kaggle/recipe-ingredients-dataset)
* [Recipe box - Structured recipes scraped from food websites](https://eightportions.com/datasets/Recipes/#fn:1) - [Code](https://github.com/rtlee9/recipe-box)
* [KitchenScale](https://www.dropbox.com/s/f6meyqlj4ep8flj/data.tar.gz?dl=0) - [Paper](https://arxiv.org/abs/2304.10739)
* [TASTEset -- Recipe Dataset and Food Entities Recognition Benchmark](https://github.com/taisti/TASTEset) - [Paper](https://arxiv.org/abs/2204.07775)
...
* [The Open Food Repo API](https://github.com/digitalepidemiologylab/foodrepo_api/tree/master/data)
* [AICrowd: Food Recognition Challenge](https://www.aicrowd.com/challenges/food-recognition-benchmark-2022#datasets)
* [MyFoodRepo: a full-stack system for professional nutrition tracking](https://github.com/digitalepidemiologylab/myfoodrepo_project)
* [Food Ingredient Lists: A list of 10,000 food products and their ingredients](https://www.kaggle.com/datasets/datafiniti/food-ingredient-lists)
* [What's On The Menu? - Dataset on historical menus, dishes, and dish prices - From New York Public Library](https://www.kaggle.com/datasets/nypl/whats-on-the-menu)
...
* [AUSNUT 2011-13 was developed to enable food, dietary supplement and nutrient intake estimates from the 2011-13 Australian Health Survey (AHS)](https://www.foodstandards.gov.au/science-data/monitoringnutrients/ausnut/ausnutdatafiles)
* [Australian Food and nutrients databases](https://www.foodstandards.gov.au/science-data/food-nutrients-databases)
* [Australian Branded Food Database](https://www.foodstandards.gov.au/science-data/monitoringnutrients/Branded-food-database)
* [The New Zealand Food Composition Database](https://www.foodcomposition.co.nz/foodfiles/)
* [Automated Cuisine Classification of Recipes](https://github.com/stevenjson/CuisineClassifying/)
* [Food and Agriculture Organization of United Nations - Food and Agriculture Statistics](https://www.fao.org/food-agriculture-statistics/data-release/en/)
* [FAOSTAT Food and agriculture data provides free access to food and agriculture data for over 245 countries and territories and covers all FAO regional groupings from 1961 to the most recent year available](https://www.fao.org/faostat/en/#home)
* [Food-101N Dataset - 310,009 images of food recipes classified in 101 classes (categories)](https://kuanghuei.github.io/Food-101N/)
* [Food-101 – Mining Discriminative Components with Random Forests](https://data.vision.ee.ethz.ch/cvl/datasets_extra/food-101/)
* [FOODD: FOOD DETECTION DATASET FOR CALORIE MEASUREMENT USING FOOD IMAGES](https://ieee-dataport.org/open-access/foodd-food-detection-dataset-calorie-measurement-using-food-images)
* [ISIA Food-500: A Dataset for Large-Scale Food Recognition via Stacked Global-Local Attention Network](http://123.57.42.89/FoodComputing-Dataset/ISIA-Food500.html)
* [UNIMIB2015 Food Database - Food Recognition](http://www.ivl.disco.unimib.it/activities/food-recognition/)
* [Food524DB is the largest publicly available food dataset with 524 food classes and 247,636 images by merging food classes from existing datasets in the state of the art](http://www.ivl.disco.unimib.it/activities/food524db/)
